...
class UserDetailsRepo with BaseApiRepository{
  ...
  Future<Either<DioException,void>> addUserDetails(UserDetailsModel userDetails) async {
    final response = getApiResponse<void>(
      request: () => addUserDetailsRemote.addUserDetails(userDetails,'application/json')
      );
