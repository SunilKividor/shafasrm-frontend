...
import 'package:shafasrm_app/features/profile/presentation/screens/loading_screen.dart';
...
import 'package:shafasrm_app/features/profile/presentation/screens/user_details_screen.dart';
...
GoRouter router(RouterRef ref) {
  return GoRouter(
    initialLocation: const UserDetailsScreenRoute().location,
    routes: $appRoutes,
    errorBuilder:
        (context, state) =>
